...
function CheckboxSF() {
  ...
  return (
    <div className="App">
      ...
      <div>
        {tagA && checked && checked.tag1 == true ? (
          <textarea rows="4" cols="50" />
        ) : null}{" "}
        <br />
        {tagB && checked && checked.tag2 == true ? (
          <textarea rows="4" cols="50" />
        ) : null}{" "}
        <br />
        {tagC && checked && checked.tag3 == true ? (
          <textarea rows="4" cols="50" />
        ) : null}{" "}
        <br />
      </div>
